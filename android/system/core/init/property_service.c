...
static int enable_adaptive_memory(void)
{
    ...
    int ret = property_get("ro.sys.adaptive_memory", buf);
    if (buf[0] == '0') {
    ...
    INFO("dalvik.vm.heapsize=%s\n", property_get("dalvik.vm.heapsize", buf));
    INFO("dalvik.vm.heapstartsize=%s\n", property_get("dalvik.vm.heapstartsize", buf));
    INFO("dalvik.vm.heapgrowthlimit=%s\n", property_get("dalvik.vm.heapgrowthlimit", buf));
    INFO("dalvik.vm.heapminfree=%s\n", property_get("dalvik.vm.heapminfree", buf));
    INFO("dalvik.vm.heapmaxfree=%s\n", property_get("dalvik.vm.heapmaxfree", buf));
	*/
    return 0;
}
