...
int main(int argc, char **argv)
{
	...
	char* args_swapon[2];
	char args_com[] = {"swapon_all"};
	char args_para[] = {"/fstab.sun7i"};
	args_swapon[0] = args_com;
	args_swapon[1] = args_para;
	
	char* args_write[3];
	char args_write_cmd[] = {"write"};
	char args_write_path[] = {"/proc/sys/vm/page-cluster"};
	char args_write_num[] = {"0"};
	args_write[0] = args_write_cmd;
 	args_write[1] = args_write_path;
	args_write[2] = args_write_num;
