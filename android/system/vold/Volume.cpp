...
int Volume::mountVol() {
    ...
    int gid, uid, permMask;
    property_get("ro.sys.storage_type", storage_type, "");

    if (strncmp(storage_type, "emulated", sizeof("emulated"))) {            // Special case the primary SD card.
        uid = AID_SYSTEM;
