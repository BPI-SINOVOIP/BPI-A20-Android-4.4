...
public class PhoneStatusBarView extends PanelBar {
    ...
    public void setShowVolume(boolean show,Context mContext){
		...
		KeyButtonView volume_up=(KeyButtonView)mNavigationBarView.findViewById(R.id.volume_up);
		KeyButtonView volume_down=(KeyButtonView)mNavigationBarView.findViewById(R.id.volume_down);
		KeyButtonView menu =(KeyButtonView)mNavigationBarView.findViewById(R.id.menu);
		KeyButtonView screenshot =(KeyButtonView)mNavigationBarView.findViewById(R.id.screen_shot);
