...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode {
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mTickerView = mStatusBarView.findViewById(R.id.ticker);
				...
				mVolumeDownButton = (View) mStatusBarWindow.findViewById(R.id.volume_down);
				mVolumeUpButton = (View) mStatusBarWindow.findViewById(R.id.volume_up);
    ...
    public void disable(int state) {
        ...
        if ((diff & (StatusBarManager.DISABLE_HOME
            ...
            if ((state & StatusBarManager.DISABLE_RECENT) != 0) {
				...
				mHasVolume = mContext.getResources().getBoolean(R.bool.hasVolumeButton);
