...
import com.android.gallery3d.app.MediaController.MediaPlayerControl;
...
//        getHolder().setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
    ...
    public void clearCurrentStat () {
    	...
    	MoviePlayer.getInstance().resetAllTextView();
    }
        ...
        try {
			...
			if(mSrtList!= null && mSrtList.size() > 0)
			{
				for(int j = 0; j < mSrtList.size(); j ++)
				{
					...
					Log.v("fuqiang","here j = " + j + ", mSrtList.get(j) = " + mSrtList.get(j) + ", mMediaTypeList.get(j) = " + mMediaTypeList.get(j));
				}
			}
	...
	public void setHdmiPluggedStatus(boolean status) {
		mCurHdmiPlugged = status;
    }

	public boolean getHdmiPluggedStatus() {
		return mCurHdmiPlugged;
    }
...
//            }
	...
	/**
     * Register a callback to be invoked when an timedtext event
...
//    }
    ...
    */
     ...
     * <p>
     * 
     * @param percent  ��Ļ���ؾ�����Ļ���صľ���ռ�����Ļ�߶ȵİٷֱȡ�����һ������ֵ��Ʃ��˵��10%������Ӧ����10.
     * @return ==0 means successful, !=0 means failed.
     */
     ...
     * <p>
     * 
     * @return percent  ��Ļ���ؾ�����Ļ���صľ���ռ�����Ļ�߶ȵİٷֱȡ�����һ������ֵ��Ʃ��˵��10%�������10.
     */
