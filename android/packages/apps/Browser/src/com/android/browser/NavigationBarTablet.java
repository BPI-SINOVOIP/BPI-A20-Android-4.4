...
public class NavigationBarTablet extends NavigationBarBase implements StateListener {
    ...
    private void stopOrRefresh() {
        ...
        if (mTitleBar.isInLoad()) {
            ...
            if (mUiController.getCurrentTopWebView() != null) {
                WebView web = mUiController.getCurrentTopWebView();
    ...
    public void onProgressStarted() {
		...
		if(mUiController.getCurrentTab().isNewTab()) {
			if (mTitleBar.isInLoad()) {
				WebView web = mUiController.getCurrentTopWebView();
				if(mUiController.getCurrentTab().getUrl() != null) {
					//mUiController.stopLoading();
					web.loadUrl(mUiController.getCurrentTab().getUrl());
					mUiController.getCurrentTab().setNotNewTab();
				}
			}
		}
    }
