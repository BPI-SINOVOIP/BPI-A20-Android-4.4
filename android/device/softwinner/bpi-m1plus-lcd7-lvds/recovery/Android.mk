ifneq (,$(findstring $(TARGET_DEVICE),bpi-m1plus-lcd7-lvds))
...
LOCAL_MODULE := librecovery_ui_bpi_m1plus_lcd7_lvds
...
LOCAL_MODULE := librecovery_updater_bpi_m1plus_lcd7_lvds
