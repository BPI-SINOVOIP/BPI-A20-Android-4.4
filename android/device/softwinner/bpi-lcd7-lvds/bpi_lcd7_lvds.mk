...
DEVICE_PACKAGE_OVERLAYS := \
	device/softwinner/bpi-lcd7-lvds/overlay \
	$(DEVICE_PACKAGE_OVERLAYS)

# Abandon useless system app. Add which module name in apk/Android.mk bpi_lcd7_lvds_app section.
PRODUCT_PACKAGES += \
	bpi_lcd7_lvds_app
...
# for recovery
PRODUCT_COPY_FILES += \
    device/softwinner/bpi-lcd7-lvds/recovery.fstab:recovery.fstab \
    device/softwinner/bpi-lcd7-lvds/modules/modules/disp.ko:obj/disp.ko \
    device/softwinner/bpi-lcd7-lvds/modules/modules/lcd.ko:obj/lcd.ko \
    device/softwinner/bpi-lcd7-lvds/modules/modules/hdmi.ko:obj/hdmi.ko \
    device/softwinner/bpi-lcd7-lvds/modules/modules/hdcp.ko:obj/hdcp.ko \
    device/softwinner/bpi-lcd7-lvds/modules/modules/ft5x_ts.ko:obj/ft5x_ts.ko \
    device/softwinner/bpi-lcd7-lvds/modules/modules/sw_device.ko:obj/sw_device.ko

PRODUCT_COPY_FILES += \
    device/softwinner/bpi-lcd7-lvds/kernel:kernel \
    device/softwinner/bpi-lcd7-lvds/fstab.sun7i:root/fstab.sun7i \
    device/softwinner/bpi-lcd7-lvds/init.sun7i.rc:root/init.sun7i.rc \
    device/softwinner/bpi-lcd7-lvds/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
    device/softwinner/bpi-lcd7-lvds/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
    device/softwinner/bpi-lcd7-lvds/modules/modules/nand.ko:root/nand.ko

PRODUCT_COPY_FILES += \
    device/softwinner/bpi-lcd7-lvds/configs/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml

PRODUCT_COPY_FILES += \
    device/softwinner/bpi-lcd7-lvds/configs/camera.cfg:system/etc/camera.cfg \
    device/softwinner/bpi-lcd7-lvds/configs/cfg-Gallery2.xml:system/etc/cfg-Gallery2.xml \
    device/softwinner/bpi-lcd7-lvds/configs/gsensor.cfg:system/usr/gsensor.cfg \
    device/softwinner/bpi-lcd7-lvds/configs/media_profiles.xml:system/etc/media_profiles.xml \
    device/softwinner/bpi-lcd7-lvds/configs/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
    device/softwinner/bpi-lcd7-lvds/configs/tp.idc:system/usr/idc/tp.idc
...
#    device/softwinner/bpi-lcd7-lvds/media/initlogo.bmp:system/media/initlogo.bmp 
...
$(call inherit-product-if-exists, device/softwinner/bpi-lcd7-lvds/modules/modules.mk)

# Overrides
PRODUCT_CHARACTERISTICS := tablet
PRODUCT_BRAND := BPI
PRODUCT_NAME := bpi_lcd7_lvds
PRODUCT_DEVICE := bpi-lcd7-lvds
