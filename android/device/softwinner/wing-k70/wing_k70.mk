...
DEVICE_PACKAGE_OVERLAYS := \
	device/softwinner/wing-k70/overlay \
	$(DEVICE_PACKAGE_OVERLAYS)

# Abandon useless system app. Add which module name in apk/Android.mk wing_k70_app section.
PRODUCT_PACKAGES += \
	wing_k70_app
...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/wing-k70/modules/modules/ft5x_ts.ko:obj/ft5x_ts.ko \
...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/wing-k70/fstab.sun7i:root/fstab.sun7i \
	device/softwinner/wing-k70/init.sun7i.rc:root/init.sun7i.rc \
    device/softwinner/wing-k70/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
...
PRODUCT_COPY_FILES += \
	device/softwinner/wing-k70/configs/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml
