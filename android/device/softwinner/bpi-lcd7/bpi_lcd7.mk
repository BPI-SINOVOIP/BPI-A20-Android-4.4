...
DEVICE_PACKAGE_OVERLAYS := \
	device/softwinner/bpi-lcd7/overlay \
	$(DEVICE_PACKAGE_OVERLAYS)

# Abandon useless system app. Add which module name in apk/Android.mk bpi_lcd7_app section.
PRODUCT_PACKAGES += \
	bpi_lcd7_app
...
# for recovery
PRODUCT_COPY_FILES += \
    device/softwinner/bpi-lcd7/recovery.fstab:recovery.fstab \
    device/softwinner/bpi-lcd7/modules/modules/disp.ko:obj/disp.ko \
...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/bpi-lcd7/configs/cfg-Gallery2.xml:system/etc/cfg-Gallery2.xml \
    device/softwinner/bpi-lcd7/configs/gsensor.cfg:system/usr/gsensor.cfg \
    device/softwinner/bpi-lcd7/configs/media_profiles.xml:system/etc/media_profiles.xml \
    device/softwinner/bpi-lcd7/configs/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
    device/softwinner/bpi-lcd7/configs/tp.idc:system/usr/idc/tp.idc
...
$(call inherit-product-if-exists, device/softwinner/bpi-lcd7/modules/modules.mk)
