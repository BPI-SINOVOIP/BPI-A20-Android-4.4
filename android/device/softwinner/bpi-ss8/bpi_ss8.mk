...
DEVICE_PACKAGE_OVERLAYS := \
	device/softwinner/bpi-ss8/overlay \
	$(DEVICE_PACKAGE_OVERLAYS)

# Abandon useless system app. Add which module name in apk/Android.mk bpi_ss8_app section.
PRODUCT_PACKAGES += \
	bpi_ss8_app
...
# for recovery
PRODUCT_COPY_FILES += \
    device/softwinner/bpi-ss8/recovery.fstab:recovery.fstab \
    device/softwinner/bpi-ss8/modules/modules/disp.ko:obj/disp.ko \
    device/softwinner/bpi-ss8/modules/modules/lcd.ko:obj/lcd.ko \
    device/softwinner/bpi-ss8/modules/modules/hdmi.ko:obj/hdmi.ko \
    device/softwinner/bpi-ss8/modules/modules/hdcp.ko:obj/hdcp.ko \
    device/softwinner/bpi-ss8/modules/modules/ft5x_ts.ko:obj/ft5x_ts.ko \
    device/softwinner/bpi-ss8/modules/modules/sw_device.ko:obj/sw_device.ko

PRODUCT_COPY_FILES += \
    device/softwinner/bpi-ss8/kernel:kernel \
    device/softwinner/bpi-ss8/fstab.sun7i:root/fstab.sun7i \
    device/softwinner/bpi-ss8/init.sun7i.rc:root/init.sun7i.rc \
    device/softwinner/bpi-ss8/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
    device/softwinner/bpi-ss8/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
    device/softwinner/bpi-ss8/modules/modules/nand.ko:root/nand.ko

PRODUCT_COPY_FILES += \
    device/softwinner/bpi-ss8/configs/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml

PRODUCT_COPY_FILES += \
    device/softwinner/bpi-ss8/configs/camera.cfg:system/etc/camera.cfg \
    device/softwinner/bpi-ss8/configs/cfg-Gallery2.xml:system/etc/cfg-Gallery2.xml \
    device/softwinner/bpi-ss8/configs/gsensor.cfg:system/usr/gsensor.cfg \
    device/softwinner/bpi-ss8/configs/media_profiles.xml:system/etc/media_profiles.xml \
    device/softwinner/bpi-ss8/configs/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
    device/softwinner/bpi-ss8/configs/tp.idc:system/usr/idc/tp.idc
...
PRODUCT_COPY_FILES += \
    device/softwinner/bpi-ss8/media/bootanimation.zip:system/media/bootanimation.zip \
    device/softwinner/bpi-ss8/media/initlogo.rle:root/initlogo.rle \
#    device/softwinner/bpi-ss8/media/boot.wav:system/media/boot.wav \
#    device/softwinner/bpi-ss8/media/bootlogo.bmp:system/media/bootlogo.bmp \
#    device/softwinner/bpi-ss8/media/initlogo.bmp:system/media/initlogo.bmp 
...
$(call inherit-product-if-exists, device/softwinner/bpi-ss8/modules/modules.mk)

# Overrides
PRODUCT_CHARACTERISTICS := tablet
PRODUCT_BRAND := BPI
PRODUCT_NAME := bpi_ss8
PRODUCT_DEVICE := bpi-ss8
PRODUCT_MODEL := BPI SS8 Tablet
